...
#ifndef HOME_WIDGET_SWIFT_H
#define HOME_WIDGET_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="home_widget",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC11home_widget21SwiftHomeWidgetPlugin")
@interface SwiftHomeWidgetPlugin : NSObject <FlutterPlugin, FlutterStreamHandler>
